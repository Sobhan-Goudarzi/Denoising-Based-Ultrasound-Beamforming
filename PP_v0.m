...
% August 2022
function [u, v, lambd, objective] = PP_v0(Phi, y, u0, v0, lambd0, eps, mu, beta, maxiter)
...
for i=1:maxiter
    ...
    %%%%%%%%%%%%%%%%%%%%%%%%%% update v %%%%%%%%%%%%%%%%%%%%%%%%%%%
    % Non-local means filtering of u_k+lambd_k/beta
    v_k = imnlmfilt(reshape(u_k+lambd_k/beta,[length(u_k)/387,387]),'DegreeOfSmoothing',0.05);
    v_k = v_k(:);
    %%%%%%%%%%%%%%%%%%%%%%%%%% update lambd %%%%%%%%%%%%%%%%%%%%%%%%%%%
