...
2. Once step 1 is completed, the weighting matrix Phi has to be made. To do so, the codes weighting_matrix.m, summation_1.m, and summation_2.m must be run one by one as ordered. 
