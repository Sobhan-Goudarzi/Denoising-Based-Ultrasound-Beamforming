...
path_dataset = ['../../PICMUS_1/database/',acquisition,'/',phantom,'/',phantom,'_',suffix,'_dataset_rf','.hdf5'];% please update the folder directory
path_scan = ['../../PICMUS_1/database/',acquisition,'/',phantom,'/',phantom,'_',suffix,'_scan','.hdf5'];% please update the folder directory
%% loading dataset
